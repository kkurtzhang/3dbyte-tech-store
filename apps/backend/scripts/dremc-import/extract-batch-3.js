...
async function fetchProducts(collection, page = 3) {  // Start from page 2
...
async function main() {
  ...
  fs.writeFileSync(
    path.join(__dirname, 'data/products-batch-3.json'),
    JSON.stringify(output, null, 2)
  );
  
  console.log(`\n✅ Extracted ${batch2.length} products for batch 3`);
