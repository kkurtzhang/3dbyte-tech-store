...
// Get batch 2 products (skip first 50)
const batch2Products = allProducts.slice(50);
console.log(`Pushing descriptions for ${batch2Products.length} batch 2 products...`);
...
async function main() {
  ...
  console.log(`\nDone! Created ${created}/${batch2Products.length} descriptions`);
}
