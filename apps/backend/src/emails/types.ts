...
export type OrderShippedEmailLabel = {
  id?: string | null
  tracking_number?: string | null
  tracking_url?: string | null
}

export type OrderShippedEmailFulfillment = {
  created_at?: string | Date | null
  data?: Record<string, unknown> | null
  id: string
  labels?: OrderShippedEmailLabel[] | null
  provider_id?: string | null
  shipped_at?: string | Date | null
}

export type OrderShippedEmailOrder = OrderPlacedEmailOrder & {
  fulfillments?: OrderShippedEmailFulfillment[] | null
}
