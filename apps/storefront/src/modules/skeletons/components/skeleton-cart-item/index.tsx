const SkeletonCartItem = () => {
  return (
    <div className="flex animate-pulse bg-skeleton-primary sm:h-[172px]">
      <div className="h-[92px] w-[92px] shrink-0 animate-pulse bg-skeleton-secondary sm:h-full sm:w-[146px]" />
      <div className="flex w-full justify-between p-5">
        <div className="flex h-full flex-col gap-3 sm:justify-between sm:gap-0">
          <div>
            <div className="mb-2 h-11 w-[100px] animate-pulse bg-skeleton-secondary sm:h-[22px] sm:w-[200px]" />
