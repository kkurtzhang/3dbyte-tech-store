      ...
      <Card className="border-destructive/20 bg-destructive/5">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">
            Once you delete your account, there is no going back. Your orders,
            account details, and saved account data will be permanently removed.
          </p>
          <DeleteAccountButton />
        </CardContent>
      </Card>
