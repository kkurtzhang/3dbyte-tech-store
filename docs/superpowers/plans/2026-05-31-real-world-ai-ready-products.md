...
- `pnpm --filter=@3dbyte-tech-store/backend test:unit -- src/scripts/__tests__/ai-ready-catalogue.unit.spec.ts src/scripts/__tests__/seed-ai-ready-catalogue.unit.spec.ts`
